...
export default function SoftwareTestPage() {
  ...
  const loadMCQs = async (selectedDifficulty: 'easy' | 'medium' | 'hard') => {
    ...
    setError(null)
    try {
      const data = await fetchMCQs('software', selectedDifficulty, 60)
      if (data.length < 60) {
  ...
  if (testStarted && mcqs.length > 0) {
    return <QuizInterface mcqs={mcqs} category="software" difficulty={difficulty!} />
  }

  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-black dark:to-gray-900 py-12 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-block p-6 bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl shadow-2xl mb-6">
            <Cpu className="w-16 h-16 text-white" />
          </div>
          <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white mb-4">
            Assistant Manager Software Test
          </h1>
